      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        {stockErrors.length > 0 && (
          ...
          >
            ...
            <Link 
              href="/products" 
              className="inline-block mt-4 text-sm font-medium text-red-800 hover:underline"
            >
              Return to Shopping
            </Link>
          </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-8">
              {/* Contact Information */}
              <div>
                <h2 className="text-xl font-light mb-6 pb-3 border-b border-gray-200">
                  Contact Information
                </h2>
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 bg-white focus:outline-none focus:ring-1 focus:ring-black"
                    />
                  </div>
                  <div>
              ...
              <button
                ...
                className="w-full py-4 bg-black text-white font-light uppercase text-sm tracking-wide hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                  ...
                  {!appliedPromo ? (
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 px-3 py-2 text-sm border border-gray-300 bg-white focus:outline-none focus:ring-1 focus:ring-black"
                      />
                      <button
                        type="button"
                        onClick={handleApplyPromo}
                        disabled={isValidatingPromo || !promoCode.trim()}
                        className="px-4 py-2 text-sm bg-black text-white hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
