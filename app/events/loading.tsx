        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="bg-gradient-to-r from-amber-600 to-orange-600 text-white py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="h-12 bg-amber-500/50 rounded-lg w-3/4 mx-auto mb-6 animate-pulse" />
                    <div className="h-6 bg-amber-500/50 rounded-lg w-2/3 mx-auto animate-pulse" />
                </div>
            </section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {[1, 2].map((i) => (
                        <div key={i} className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                            <div className="h-[400px] bg-gray-300 animate-pulse" />
            ...
            <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="h-8 bg-gray-300 rounded w-56 mb-8 animate-pulse" />
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[1, 2, 3, 4, 5, 6].map((i) => (
                        <div key={i} className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                            <div className="h-[280px] bg-gray-300 animate-pulse" />
                            <div className="p-6 space-y-4">
                                <div className="h-4 bg-gray-300 rounded w-24 animate-pulse" />
                                <div className="h-6 bg-gray-300 rounded w-3/4 animate-pulse" />
                                <div className="h-4 bg-gray-300 rounded w-full animate-pulse" />
