export default function EventLoading() {
    return (
        <div className="min-h-screen bg-brand-cream">
            {/* Hero Image Skeleton */}
            <div className="relative h-[60vh] min-h-[400px] bg-neutral-200 animate-pulse" />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="h-10 bg-neutral-200 rounded w-3/4 mb-6 animate-pulse" />
                        <div className="h-6 bg-neutral-200 rounded w-full mb-4 animate-pulse" />
